...
DATABASES = {
    'default': {
        ...
        'HOST': 'aws-capstone-rds.cxdqcpfsf2cu.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstoneseyongesiblog' # please enter your s3 bucket name
